...
/**
 * You must use this class when constructing your Queue. This class represents a
 * link of the linked list. Your queue will be composed of these links.
 * 
 * @author archam
 *
 */
public class QueueElement<E> {
	...
	/**
	 * Constructs a queue element with given element and next element.
	 * 
	 * @param e The data stored in the queue element.
