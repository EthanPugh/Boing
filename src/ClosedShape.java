...
public class ClosedShape {
	...
	/**
	 * The line colour of the shape, or the filled in colour if the Shape has fill.
	 */
	...
	/**
	 * Determines if the Shape will pulse.
	 */
	protected boolean willPulse;
	...
	/**
	 * @return True if the shape will pulse, false otherwise.
	 */
	public boolean willPulse() {
		return willPulse;
	}
